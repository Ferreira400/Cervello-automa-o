...
import java.util.*;
public class RegistroTopicoTest {
...
vars.put("window_handles", driver.getWindowHandles());
    ...
    vars.put("win4491", waitForWindow(2000));
    driver.switchTo().window(vars.get("win4491").toString());
    driver.findElement(By.cssSelector(".laptop--18:nth-child(2)")).click();
    driver.findElement(By.name("top_Descricao")).click();
    driver.findElement(By.name("top_Descricao")).sendKeys("teste1000"
    		+ "");
