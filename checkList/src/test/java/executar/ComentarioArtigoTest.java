...
public class ComentarioArtigoTest {
	...
	public void comentarioArtigoTakeScreenShot1() throws InterruptedException, IOException {
		...
		// WebElement element = driver.findElement(By.id("hplogo"));
		 ...
		 element = driver.findElement(By.xpath("//*[@id=\"frmLogin\"]/figure/img"));
		...
		// Recorta a captura de tela da página inteira para obter apenas a captura de
		// tela do elemento
	...
	/*
	 * 
	 * @Test public void comentarioArtigoTakeScreenShot2() throws
	 * InterruptedException, IOException {
	 * 
	 * System.setProperty("webdriver.chrome.driver",
	 * "C:\\Users\\10097\\git\\Cervello-Automacao\\chromedriver.exe"); WebDriver
	 * driver = new ChromeDriver();
	 * 
	 ...
	 * File("C:\\Users\\10097\\git\\Print\\ElementScreenshot.jpg")); }
	 * 
	 */
	...
	public void comentarioArtigoTakeScreenShot() throws InterruptedException, IOException {
		 ...
		 * takeScreenShot(); Thread.sleep(4000);
		 * 
		 * driver.findElement(By.id("txtComentario")).click(); takeScreenShot();
		 * Thread.sleep(4000);
		 * driver.findElement(By.id("txtComentario")).sendKeys("fazendo teste " + i );
		 * 
		 * Thread.sleep(2000); driver.findElement(By.id("btnComentar")).click();
		 * 
		 * Thread.sleep(4000);
		 * 
		 * }
	...
	/*	
		...
		*/
		...
		/*
		 * Thread.sleep(8000); driver.findElement(By.id("txtComentario")).click();
		 * Thread.sleep(8000);
		 * driver.findElement(By.id("txtComentario")).sendKeys("fazendo teste 7");
		 * Thread.sleep(8000); driver.findElement(By.id("btnComentar")).click();
		 * Thread.sleep(8000); driver.findElement(By.id("txtComentario")).click();
		 * Thread.sleep(8000);
