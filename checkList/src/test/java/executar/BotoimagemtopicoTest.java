...
import java.util.*;
public class BotoimagemtopicoTest {
  ...
  @Test
  public void botoimagemtopico() throws InterruptedException {
    ...
    Thread.sleep(3000);
    vars.put("win8267", waitForWindow(2000));
    driver.switchTo().window(vars.get("win8267").toString());
    ...
    Thread.sleep(3000);
    vars.put("win5398", waitForWindow(2000));
    driver.switchTo().window(vars.get("win5398").toString());
    Thread.sleep(3000);
  }
}
