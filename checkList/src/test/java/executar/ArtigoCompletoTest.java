...
public class ArtigoCompletoTest {
  ...
  @Test
  public void /*testejepe*/ teste2() throws InterruptedException {
    ...
    driver.findElement(By.name("top_Descricao")).sendKeys("Junit6" + "");
  ...
  public void /*excluirComentario*/teste3() throws InterruptedException {
   ...
   // driver.findElement(By.xpath("//body[contains(.,\'dddddddddddd\')]")).click();
    ...
    driver.findElement(By.xpath("//option[. = 'Junit6']")).click();
