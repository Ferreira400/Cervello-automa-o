...
public class CriarArtigoTest {
  ...
  @Test
  public void criarArtigo() throws InterruptedException {
    ...
    driver.findElement(By.id("txtTitulo")).sendKeys("Achado");
    ...
    Thread.sleep(8000);
    driver.findElement(By.id("txtDescricao")).sendKeys("Achado");
    driver.findElement(By.id("txtPalavraChave")).click();
    driver.findElement(By.id("txtPalavraChave")).sendKeys("Achado");
