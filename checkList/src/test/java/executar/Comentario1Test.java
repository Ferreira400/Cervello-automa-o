...
public class Comentario1Test {
  ...
  public void comentario() throws InterruptedException {
   ...
   // Util.tempo(4);
    ...
    Thread.sleep(8000);
    vars.put("win221", waitForWindow(2000));
    driver.switchTo().window(vars.get("win221").toString());
  ...
  Thread.sleep(8000);
    driver.findElement(By.cssSelector(".base__comentario--portal:nth-child(11) .acao--simples")).click();
     Thread.sleep(8000);
       driver.findElement(By.cssSelector(".base__comentario--portal:nth-child(12) .acao--simples")).click();
    Thread.sleep(8000);
    /*driver.findElement(By.cssSelector(".base__comentario--portal:nth-child(7) .acao--simples")).click();
    Thread.sleep(8000);
    driver.findElement(By.cssSelector(".base__comentario--portal:nth-child(6) .acao--simples")).click();
    Thread.sleep(8000);
   */
    driver.findElement(By.id("txtComentario")).click();
    Thread.sleep(8000);
    driver.findElement(By.id("txtComentario")).sendKeys("Feito a aprovação");
    Thread.sleep(8000);
